...
createFactor <- function(x, levels) {
    .Call('h5_createFactor', PACKAGE = 'h5', x, levels)
}
...
h5CreateFile <- function(filePath, overwrite) {
    .Call('h5_h5CreateFile', PACKAGE = 'h5', filePath, overwrite)
}
...
h5CreateMetaData <- function(filePath) {
    .Call('h5_h5CreateMetaData', PACKAGE = 'h5', filePath)
}
...
h5WriteCharVector <- function(charName, charVec, filePath, update) {
    .Call('h5_h5WriteCharVector', PACKAGE = 'h5', charName, charVec, filePath, update)
}
...
h5WriteInt <- function(intName, integer, filePath, update) {
    .Call('h5_h5WriteInt', PACKAGE = 'h5', intName, integer, filePath, update)
}
...
h5WriteFactor <- function(charName, charVec, filePath, update) {
    .Call('h5_h5WriteFactor', PACKAGE = 'h5', charName, charVec, filePath, update)
}
...
h5WriteDoubleMat <- function(dset, chunk, dim, filePath) {
    .Call('h5_h5WriteDoubleMat', PACKAGE = 'h5', dset, chunk, dim, filePath)
}
...
h5FlushFile <- function(filePath) {
    .Call('h5_h5FlushFile', PACKAGE = 'h5', filePath)
}
...
h5CloseFile <- function(filePath) {
    .Call('h5_h5CloseFile', PACKAGE = 'h5', filePath)
}
...
h5ReadCharVector <- function(charName, filePath) {
    .Call('h5_h5ReadCharVector', PACKAGE = 'h5', charName, filePath)
}
...
h5ReadFactor <- function(charName, filePath) {
    .Call('h5_h5ReadFactor', PACKAGE = 'h5', charName, filePath)
}
...
h5ReadInt <- function(intName, filePath) {
    .Call('h5_h5ReadInt', PACKAGE = 'h5', intName, filePath)
}
...
h5ReadDoubleMat <- function(chunkName, filePath) {
    .Call('h5_h5ReadDoubleMat', PACKAGE = 'h5', chunkName, filePath)
}
...
h5DummyRead <- function(chunkName, filePath) {
    .Call('h5_h5DummyRead', PACKAGE = 'h5', chunkName, filePath)
}
...
h5ModelFrame <- function(chunkName, selCols_, filePath) {
    .Call('h5_h5ModelFrame', PACKAGE = 'h5', chunkName, selCols_, filePath)
}
...
h5ChunkList <- function(chunkName, filePath) {
    .Call('h5_h5ChunkList', PACKAGE = 'h5', chunkName, filePath)
}
...
h5ChunkSel <- function(chunkName, selCols, filePath) {
    .Call('h5_h5ChunkSel', PACKAGE = 'h5', chunkName, selCols, filePath)
}
...
h5ReadDoubleMat2 <- function(chunkName, filePath) {
    .Call('h5_h5ReadDoubleMat2', PACKAGE = 'h5', chunkName, filePath)
}
...
h5ReadDoubleMat3 <- function(chunkName, filePath) {
    .Call('h5_h5ReadDoubleMat3', PACKAGE = 'h5', chunkName, filePath)
}
...
h5WriteMemMAT <- function(obj) {
    .Call('h5_h5WriteMemMAT', PACKAGE = 'h5', obj)
}
...
h5WriteMemDF <- function(obj) {
    .Call('h5_h5WriteMemDF', PACKAGE = 'h5', obj)
}
...
h5ReadMemMAT <- function(ptr) {
    .Call('h5_h5ReadMemMAT', PACKAGE = 'h5', ptr)
}
...
h5ReadMemDF <- function(ptr) {
    .Call('h5_h5ReadMemDF', PACKAGE = 'h5', ptr)
}
