...
#ifndef __h5_RcppExports_h__
#define __h5_RcppExports_h__
...
namespace h5 {
    ...
    inline SEXP createFactor(NumericVector x, CharacterVector levels) {
        ...
        if (p_createFactor == NULL) {
            ...
            p_createFactor = (Ptr_createFactor)R_GetCCallable("h5", "h5_createFactor");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5CreateFile(std::string filePath, int overwrite) {
        ...
        if (p_h5CreateFile == NULL) {
            ...
            p_h5CreateFile = (Ptr_h5CreateFile)R_GetCCallable("h5", "h5_h5CreateFile");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5CreateMetaData(std::string filePath) {
        ...
        if (p_h5CreateMetaData == NULL) {
            ...
            p_h5CreateMetaData = (Ptr_h5CreateMetaData)R_GetCCallable("h5", "h5_h5CreateMetaData");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5WriteCharVector(std::string charName, SEXP charVec, std::string filePath, int update) {
        ...
        if (p_h5WriteCharVector == NULL) {
            ...
            p_h5WriteCharVector = (Ptr_h5WriteCharVector)R_GetCCallable("h5", "h5_h5WriteCharVector");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5WriteInt(std::string intName, int integer, std::string filePath, int update) {
        ...
        if (p_h5WriteInt == NULL) {
            ...
            p_h5WriteInt = (Ptr_h5WriteInt)R_GetCCallable("h5", "h5_h5WriteInt");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5WriteFactor(std::string charName, SEXP charVec, std::string filePath, int update) {
        ...
        if (p_h5WriteFactor == NULL) {
            ...
            p_h5WriteFactor = (Ptr_h5WriteFactor)R_GetCCallable("h5", "h5_h5WriteFactor");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5WriteDoubleMat(std::string dset, SEXP chunk, NumericVector dim, std::string filePath) {
        ...
        if (p_h5WriteDoubleMat == NULL) {
            ...
            p_h5WriteDoubleMat = (Ptr_h5WriteDoubleMat)R_GetCCallable("h5", "h5_h5WriteDoubleMat");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5FlushFile(std::string filePath) {
        ...
        if (p_h5FlushFile == NULL) {
            ...
            p_h5FlushFile = (Ptr_h5FlushFile)R_GetCCallable("h5", "h5_h5FlushFile");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5CloseFile(std::string filePath) {
        ...
        if (p_h5CloseFile == NULL) {
            ...
            p_h5CloseFile = (Ptr_h5CloseFile)R_GetCCallable("h5", "h5_h5CloseFile");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ReadCharVector(std::string charName, std::string filePath) {
        ...
        if (p_h5ReadCharVector == NULL) {
            ...
            p_h5ReadCharVector = (Ptr_h5ReadCharVector)R_GetCCallable("h5", "h5_h5ReadCharVector");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ReadFactor(std::string charName, std::string filePath) {
        ...
        if (p_h5ReadFactor == NULL) {
            ...
            p_h5ReadFactor = (Ptr_h5ReadFactor)R_GetCCallable("h5", "h5_h5ReadFactor");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5ReadInt(std::string intName, std::string filePath) {
        ...
        if (p_h5ReadInt == NULL) {
            ...
            p_h5ReadInt = (Ptr_h5ReadInt)R_GetCCallable("h5", "h5_h5ReadInt");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ReadDoubleMat(std::string chunkName, std::string filePath) {
        ...
        if (p_h5ReadDoubleMat == NULL) {
            ...
            p_h5ReadDoubleMat = (Ptr_h5ReadDoubleMat)R_GetCCallable("h5", "h5_h5ReadDoubleMat");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline int h5DummyRead(std::string chunkName, std::string filePath) {
        ...
        if (p_h5DummyRead == NULL) {
            ...
            p_h5DummyRead = (Ptr_h5DummyRead)R_GetCCallable("h5", "h5_h5DummyRead");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ModelFrame(std::string chunkName, SEXP selCols_, std::string filePath) {
        ...
        if (p_h5ModelFrame == NULL) {
            ...
            p_h5ModelFrame = (Ptr_h5ModelFrame)R_GetCCallable("h5", "h5_h5ModelFrame");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ChunkList(std::string chunkName, std::string filePath) {
        ...
        if (p_h5ChunkList == NULL) {
            ...
            p_h5ChunkList = (Ptr_h5ChunkList)R_GetCCallable("h5", "h5_h5ChunkList");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ChunkSel(std::string chunkName, SEXP selCols, std::string filePath) {
        ...
        if (p_h5ChunkSel == NULL) {
            ...
            p_h5ChunkSel = (Ptr_h5ChunkSel)R_GetCCallable("h5", "h5_h5ChunkSel");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ReadDoubleMat2(std::string chunkName, std::string filePath) {
        ...
        if (p_h5ReadDoubleMat2 == NULL) {
            ...
            p_h5ReadDoubleMat2 = (Ptr_h5ReadDoubleMat2)R_GetCCallable("h5", "h5_h5ReadDoubleMat2");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5ReadDoubleMat3(std::string chunkName, std::string filePath) {
        ...
        if (p_h5ReadDoubleMat3 == NULL) {
            ...
            p_h5ReadDoubleMat3 = (Ptr_h5ReadDoubleMat3)R_GetCCallable("h5", "h5_h5ReadDoubleMat3");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5WriteMemMAT(NumericMatrix obj) {
        ...
        if (p_h5WriteMemMAT == NULL) {
            ...
            p_h5WriteMemMAT = (Ptr_h5WriteMemMAT)R_GetCCallable("h5", "h5_h5WriteMemMAT");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline SEXP h5WriteMemDF(DataFrame obj) {
        ...
        if (p_h5WriteMemDF == NULL) {
            ...
            p_h5WriteMemDF = (Ptr_h5WriteMemDF)R_GetCCallable("h5", "h5_h5WriteMemDF");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline NumericMatrix h5ReadMemMAT(SEXP ptr) {
        ...
        if (p_h5ReadMemMAT == NULL) {
            ...
            p_h5ReadMemMAT = (Ptr_h5ReadMemMAT)R_GetCCallable("h5", "h5_h5ReadMemMAT");
        }
        RObject __result;
        {
            RNGScope __rngScope;
    ...
    inline DataFrame h5ReadMemDF(SEXP ptr) {
        ...
        if (p_h5ReadMemDF == NULL) {
            ...
            p_h5ReadMemDF = (Ptr_h5ReadMemDF)R_GetCCallable("h5", "h5_h5ReadMemDF");
        }
        RObject __result;
        {
            RNGScope __rngScope;
